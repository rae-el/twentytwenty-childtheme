...
<article <?php post_class(); ?> id="post-<?php the_ID(); ?>">
	...
	$image_url = ! post_password_required() ? get_the_post_thumbnail_url( get_the_ID(), 'twentytwenty-fullscreen' ) : '..\assets\images\ocean_bg.jpg';
	//$image_url = '.\assets\images\ocean_bg.jpg';
